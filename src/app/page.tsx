...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800 text-slate-50">
      ...
      <section className="container grid gap-12 py-20 md:grid-cols-2 md:py-32">
        <div className="flex flex-col justify-center gap-6">
          ...
          <h1 className="text-4xl font-bold leading-tight md:text-6xl">
            Broke down? <br />
            <span className="text-amber-400">Help is on the way.</span>
          </h1>
          <p className="max-w-prose text-lg text-slate-300">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-slate-100 bg-transparent text-slate-100 hover:bg-slate-100 hover:text-slate-950"
            >
      ...
      <footer className="container border-t border-slate-800 py-6 text-sm text-slate-400">
...
function Feature({ title, body }: { title: string; body: string }) {
  return (
    <div className="rounded-xl border border-slate-700 bg-slate-900/50 p-5">
      <h3 className="mb-1 text-lg font-semibold text-amber-400">{title}</h3>
